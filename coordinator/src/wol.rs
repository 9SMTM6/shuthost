...
pub fn test_wol_reachability(target_ip: &str, target_port: u16) -> Result<(bool, bool), String> {
    ...
    socket.send_to(test_message, format!("{}:{}", target_ip, target_port))
    ...
    socket.send_to(test_message, format!("255.255.255.255:{}", target_port))
