...
coverage:
    ...
    cargo llvm-cov report --html --output-dir target/coverage --ignore-filename-regex "src/bin/coordinator.rs|src/bin/host_agent.rs|.*cargo/registry/src/.*|tests/integration/.*"
