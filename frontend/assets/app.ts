...
const setupInstallerCommands = () => {
    ...
    clientInstallCommandSh.textContent = `curl -sSL ${baseUrl}/download/client_installer.sh | sh -s ${baseUrl} # [optional_client_id]`;
    clientInstallCommandPs1.textContent = `Invoke-WebRequest -Uri '${baseUrl}/download/client_installer.ps1' -UseBasicParsing -OutFile 'client_installer.ps1'; powershell -ExecutionPolicy Bypass -File .\\client_installer.ps1 ${baseUrl} # [optional_client_id]`;
}
