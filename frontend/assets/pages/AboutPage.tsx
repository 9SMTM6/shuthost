...
import { For, Suspense, Switch, Match, createResource } from 'solid-js';
            ...
            <section class="py-4 sm:py-6" aria-labelledby="about-page-title">
                ...
                <section class="section-container" aria-labelledby="about-shuthost-title">
                    ...
                    <div class="m-4 text-sm sm:text-base text-[#616161] dark:text-[#9d9d9d] space-y-3">
                        ...
                        <p>
                            <a href={buildData.repository} class="link font-medium">
                ...
                <section class="section-container mt-4" aria-labelledby="dependencies-title">
                    ...
                    <Suspense fallback={<p class="mx-4 mb-4 text-sm text-[#616161] dark:text-[#9d9d9d]">Loading…</p>}>
                        <Switch>
                            <Match when={deps()?.kind === 'unauthorized'}>
                                <p class="mx-4 mb-4 text-sm text-[#616161] dark:text-[#9d9d9d]">
                                    <a href="/login" class="link font-medium">Log in</a> to view open source dependencies.
                                </p>
                            </Match>

                            <Match when={deps()?.kind === 'error' ? deps() as Extract<DepsResult, { kind: 'error' }> : undefined}>
                                {err => (
                            ...
                            <Match when={deps()?.kind === 'ok' ? (deps() as Extract<DepsResult, { kind: 'ok' }>).data : undefined}>
                                {data => (
                                    <>
