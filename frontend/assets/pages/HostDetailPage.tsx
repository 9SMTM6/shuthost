...
import { demoUpdateLease, initDemoMode, isDemoMode } from '../helpers/demo';
                ...
                <section class="py-4 sm:py-6">
                    ...
                    <Show when={!isLoading() && !isKnown()}>
                        <div class="alert alert-error">
                            ...
                            <p>
                                No host named <strong>{hostname()}</strong> is
                                known to this coordinator.
                            </p>
                        </div>
                    </Show>
                        ...
                        >
                            ...
                            <div class="mb-4 pb-4 border-b border-[#e5e5e5] dark:border-[#3e3e42]">
                                ...
                                <p class="description-text text-xs mb-2">
                                    Get a push notification when this host has
                                    been continuously online for longer than the
                                    given duration.
                                </p>
                            ...
                            <div>
                                ...
                                <p class="description-text text-xs mb-2">
                                    Get a push notification when this host
                                    starts up or shuts down without being
                                    triggered by ShutHost.
                                </p>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <span
                                            ...
                                            aria-live="polite"
                                        >
                                            Failed to subscribe. Please try
                                            again.
                                        </span>
                                    </Show>
                                </div>
