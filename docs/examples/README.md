...
- **[CLI subcommand help outputs](docs/examples/cli_help_output)**: Generated text files containing CLI subcommand help (sanitized); useful for installer and documentation references.
